...
> 1. For any integer $a$ such that $0\leq a\leq k,\ 
		{n\choose k}=\frac{n(n-1)\cdots(n-a+1)}{k(k-1)\cdots(k-a+1)}{n-a\choose k-a}$ (Theorem \@ref(Combinations1.3)).
> 2. Let $y=x-1$\ \ $\Rightarrow x=y+1$.
> 3. $\frac{\sum\limits_{i=1}^{n}{N_1\choose i}{N_2\choose n-i}}{{N_1+N_2\choose n}}=1$\\
		\indent with $N_1=r,\ N_2=N-r,\ i=x$.  (Theorem \@ref(BinomialTheor3.2)
...
Theorem \@ref(BinomialTheor3.1) states
