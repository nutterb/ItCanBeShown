...
```{r, echo = FALSE, fig.cap = 'The graphs on the top and bottom depict the Chi-Square probability distribution and cumulative distribution functions, respectively, for $\\nu=4,7,10$.  As $\\nu$ gets larger, the distribution becomes flatter with thicker tails.'}
ChiSquare <- 
